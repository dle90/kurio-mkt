// Two analyses, both ORDER-BASED revenue + Getfly ads_code attribution:
...
// ---- Order-based revenue per (code, month) — Getfly ads_code attribution ----
const rev = new Map();
for (const o of ORDERS) {
  ...
  if (!code) continue;
  rev.set(code + '|' + month, (rev.get(code + '|' + month) || 0) + amt);
}
...
// Console output
// ============================================================
console.log('=== (a) COHORT × AGE — order-based revenue, Getfly attribution ===');
